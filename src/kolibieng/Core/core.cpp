...
private:
    ...
    void processinput(){
        ...
        if(inputa == "exit" || inputa == "ext"){
            ...
            cout << "available commands: help, exit, ext, status, core --version / core --v, --about, authors" << endl;

        }
        else if (inputa == "authors"){
             cout << "Studio & author : GP Interactive | Maker & author : Belleer" << endl;
        }
         else if (inputa == "--about"){
             cout << "Studio & author : GP Interactive | Maker & author : Belleer" << endl;
             cout << "Engine name : Kolibri" << endl;
             cout << "Engine version : 0.0.0.1" << endl;
        }
